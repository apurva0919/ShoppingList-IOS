...
var invitationOutput:[[String: Any]]  = [[String: Any]] ()
struct Invitation {
  //  var invitationDetail = SHOPPINGLISTInvitationGET()
    func invitationGET(inviteeName: String) {
        invitationOutput = [[String:Any]]()
        guard let url = URL(string: "https://tdgp7lq6ki.execute-api.us-east-2.amazonaws.com/dev/invitationfunction/\(inviteeName)") else {return}
        let task = URLSession.shared.dataTask(with: url) { (data, response, error) in
            ...
            do{
              ...
              //  print(jsonResponse) //Response result
                ...
                invitationOutput = jsonArray
                print("aaaaaaaaaaa\(invitationOutput)")
                // print(itemsDict)
    ...
    //MARK: POST LIST
    func inviteePOST(newItem: SHOPPINGLISTInvitationPost){
        //  var newList = SHOPPINGLISTListPOST()
        //newList?.userName = "apoo"
        //newList?.listName = "list9"
        guard let todosURL = URL(string: "https://tdgp7lq6ki.execute-api.us-east-2.amazonaws.com/dev/invitationfunction") else {
